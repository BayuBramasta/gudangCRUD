            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal1" data-bs-supplier="<?=$supplier['supplier'] ?>" data-bs-address="<?=$supplier['address'] ?>" data-bs-id="<?=$supplier['id'] ?>">
                  <b>Edit</b>
                </button></td>
